...
public class TblSysuserInfo implements java.io.Serializable{
    ...
    public TblSysuserInfo(String userNo,String userName,String userNickname,String loginName,String password,String userStatus,String applicationCode,Long userIcon,String lastLoginIp,String lastLoginTm,String createTime,String upTime) {
        this.userNo = userNo;
