...
public class TblTaskBasicConfig implements java.io.Serializable{
    ...
    public TblTaskBasicConfig(String id,String taskName,String parentId,String runRule,String runStatus,String status,String businessObjName,Integer taskCount,String internetName,String serverIp,String businessInfo,String logFlg,String continueFlg,String configTime,String upPerson,String upTime) {
        this.id = id;
