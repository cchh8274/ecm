...
public class TblFileInfo implements java.io.Serializable{
    ...
    public TblFileInfo(Long fileNo,String businessType,String businessNo,String fileName,String filePath,String fileRootPath,String createTm,String fileStat,String fileSize,String fileDesc) {
        this.fileNo = fileNo;
