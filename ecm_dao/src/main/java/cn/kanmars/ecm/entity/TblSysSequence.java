...
public class TblSysSequence implements java.io.Serializable{
    ...
    public TblSysSequence(Integer id,String keyValue,String seqDesc,String top,String suffix,Long currValue,Long batchSize,String createTime,String upTime) {
        this.id = id;
