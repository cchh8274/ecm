...
public class TaskBasicConfig {
	...
	/**
	 * 日志开关
	 * tbl_task_basic_config.log_flg
	 */
	private String logFlg;

	/**
	 * 循环执行
	 * tbl_task_basic_config.continue_flg
	 */
	...
	public TaskBasicConfig(){super();}
	public TaskBasicConfig(String id,String taskName,String parentId,String runRule,String runStatus,String status,String businessObjName,Integer taskCount,String internetName,String serverIp,String businessInfo,String logFlg,String continueFlg,String configTime,String upPerson,String upTime) {
		this.id = id;
