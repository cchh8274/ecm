...
import cn.kanmars.ecm.logic.WxUserInfoLogic;
...
public class WxUserInfoController extends AdvancedAjaxBaseController  {

    protected HLogger logger = LoggerManager.getLoger("WxUserInfoController");

    @Autowired
    private WxUserInfoLogic wxUserInfoLogic;

    @RequestMapping("/wxUserInfoView.dhtml")
    public String init() {
        return "wxuserinfo/wxuserinfo";
    }
    ...
    public void queryObject(HttpServletRequest request, HttpServletResponse response) {
        ...
        TblWxUserInfo tblWxUserInfo = new TblWxUserInfo();
        tblWxUserInfo.setId(Integer.parseInt(jsonObject.get("id_key").toString()));// 联合主键用逗号分割

        try {
            tblWxUserInfo = wxUserInfoLogic.queryWxUserInfo(tblWxUserInfo);
            logger.info("查询结果:tblWxUserInfo:" + (tblWxUserInfo != null ? JSONObject.fromObject(tblWxUserInfo).toString() : "null"));
            Map result = new HashMap();
            Map tblWxUserInfo_map = afterLogic(request, JSONObject.fromObject(tblWxUserInfo));
            result.put("tblWxUserInfo", tblWxUserInfo_map);
    ...
    public void insert(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            TblWxUserInfo tblWxUserInfo = new TblWxUserInfo();
            try {
                MapObjTransUtils.mapToObj(tblWxUserInfo, paramMap);
            } catch (Exception e) {
            ...
            logger.info("传入参数:tblWxUserInfo:" + JSONObject.fromObject(tblWxUserInfo).toString());
            int count = wxUserInfoLogic.insertWxUserInfo(tblWxUserInfo);
    ...
    public void edit(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            logger.info("传入参数:tblWxUserInfo:" + JSONObject.fromObject(tblWxUserInfo).toString());
            int count = wxUserInfoLogic.updateWxUserInfo(tblWxUserInfo);
            if (count == 0) {
    ...
    public void del(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            for (String s : id_key.split(";")) { // 多个主键用分号分割
                logger.info("尝试删除:" + s);
                TblWxUserInfo tblWxUserInfo = new TblWxUserInfo();
                tblWxUserInfo.setId(Integer.parseInt(s));// 联合主键用逗号分割
                try {
                    count += wxUserInfoLogic.deleteWxUserInfo(tblWxUserInfo);
                } catch(Exception e) {
    ...
    public void search(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            paramMap = wxUserInfoLogic.queryPageWxUserInfo(paramMap);
