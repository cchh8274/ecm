...
import cn.kanmars.ecm.logic.UnionDemoSlavebInfoLogic;
 ...
 */
@Controller
@RequestMapping("/unionDemoSlavebInfo")
public class UnionDemoSlavebInfoController extends AdvancedAjaxBaseController  {

    protected HLogger logger = LoggerManager.getLoger("UnionDemoSlavebInfoController");

    @Autowired
    private UnionDemoSlavebInfoLogic unionDemoSlavebInfoLogic;

    @RequestMapping("/unionDemoSlavebInfoView.dhtml")
    public String init() {
        return "uniondemoslavebinfo/uniondemoslavebinfo";
    }
    ...
    public void queryObject(HttpServletRequest request, HttpServletResponse response) {
        ...
        tblUnionDemoSlavebInfo.setDemoIdb(Long.parseLong(jsonObject.get("id_key").toString()));// 联合主键用逗号分割

        try {
            tblUnionDemoSlavebInfo = unionDemoSlavebInfoLogic.queryUnionDemoSlavebInfo(tblUnionDemoSlavebInfo);
            logger.info("查询结果:tblUnionDemoSlavebInfo:" + (tblUnionDemoSlavebInfo != null ? JSONObject.fromObject(tblUnionDemoSlavebInfo).toString() : "null"));
            Map result = new HashMap();
            Map tblUnionDemoSlavebInfo_map = afterLogic(request, JSONObject.fromObject(tblUnionDemoSlavebInfo));
            result.put("tblUnionDemoSlavebInfo", tblUnionDemoSlavebInfo_map);
    ...
    public void insert(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            try {
                ...
                tblUnionDemoSlavebInfo.setDemoIdb(Long.parseLong(pk0));// 联合主键用逗号分割
                String pk1 = SysSequenceUtils.generateStringId("tbl_demo_info");
            } catch (Exception e) {
                logger.error("对象转化异常", e);
            }
            logger.info("传入参数:tblUnionDemoSlavebInfo:" + JSONObject.fromObject(tblUnionDemoSlavebInfo).toString());
            int count = unionDemoSlavebInfoLogic.insertUnionDemoSlavebInfo(tblUnionDemoSlavebInfo);
    ...
    public void edit(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            logger.info("传入参数:tblUnionDemoSlavebInfo:" + JSONObject.fromObject(tblUnionDemoSlavebInfo).toString());
            int count = unionDemoSlavebInfoLogic.updateUnionDemoSlavebInfo(tblUnionDemoSlavebInfo);
            if (count == 0) {
    ...
    public void del(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            for (String s : id_key.split(";")) { // 多个主键用分号分割
                logger.info("尝试删除:" + s);
                TblUnionDemoSlavebInfo tblUnionDemoSlavebInfo = new TblUnionDemoSlavebInfo();
                tblUnionDemoSlavebInfo.setDemoIdb(Long.parseLong(s));// 联合主键用逗号分割
                try {
                    count += unionDemoSlavebInfoLogic.deleteUnionDemoSlavebInfo(tblUnionDemoSlavebInfo);
                } catch(Exception e) {
    ...
    public void search(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            paramMap = unionDemoSlavebInfoLogic.queryPageUnionDemoSlavebInfo(paramMap);
