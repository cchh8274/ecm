$(function(){
    ...
    $("#querySysroleInfoForm #createTime").ECalendar({
        type:"time",
        stamp : false,
        offset:[0,2],
        ...
        skin:1,
        step:1,
        callback:function(v,e){revalidateDate("querySysroleInfoForm","createTime");} //回调函数
    });
    $("#validateUpdateSysroleInfoForm #createTime3").ECalendar({
        type:"time",
        stamp : false,
        offset:[0,2],
        format:"yyyy-mm-dd hh:ii:ss",
        skin:1,
        step:1,
        callback:function(v,e){revalidateDate("validateUpdateSysroleInfoForm","createTime3");} //回调函数
    });
