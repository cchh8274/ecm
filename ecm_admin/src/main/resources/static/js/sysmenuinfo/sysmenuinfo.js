$(function(){
    ...
    $("#querySysmenuInfoForm #createTime").ECalendar({
        type:"time",
        stamp : false,
        offset:[0,2],
        ...
        skin:1,
        step:1,
        callback:function(v,e){revalidateDate("querySysmenuInfoForm","createTime");} //回调函数
    });
    $("#validateAddSysmenuInfoForm #createTime1").ECalendar({
        type:"time",
        stamp : false,
        offset:[0,2],
        format:"yyyy-mm-dd hh:ii:ss",
        skin:1,
        step:1,
        callback:function(v,e){revalidateDate("validateAddSysmenuInfoForm","createTime1");} //回调函数
    });
    $("#validateUpdateSysmenuInfoForm #createTime3").ECalendar({
        type:"time",
        stamp : false,
        offset:[0,2],
        format:"yyyy-mm-dd hh:ii:ss",
        skin:1,
        step:1,
        callback:function(v,e){revalidateDate("validateUpdateSysmenuInfoForm","createTime3");} //回调函数
    });
    $("#querySysmenuInfoForm #upTime").ECalendar({
        type:"time",
        stamp : false,
        offset:[0,2],
        format:"yyyy-mm-dd hh:ii:ss",
        skin:1,
        step:1,
        callback:function(v,e){revalidateDate("querySysmenuInfoForm","upTime");} //回调函数
    });
    $("#validateAddSysmenuInfoForm #upTime1").ECalendar({
        type:"time",
        stamp : false,
        offset:[0,2],
        format:"yyyy-mm-dd hh:ii:ss",
        skin:1,
        step:1,
        callback:function(v,e){revalidateDate("validateAddSysmenuInfoForm","upTime1");} //回调函数
    });
    ...
    $('#validateAddSysmenuInfoForm').bootstrapValidator({
        fields : {
            ...
            ,
            parentMenuCode1 : {
                validators : {"notEmpty":{"message":"菜单编号不能为空"},"stringLength":{"min":1,"max":8,"message":"父菜单编码长度不正确"},"regexp":{"regexp":"^[0-9\\-]*$","message":"父菜单编码只能是数字或者中划线"}}
            }
            ,
            menuUrl1 : {
    ...
    $('#querySysmenuInfoForm').bootstrapValidator({
        fields : {
            ...
            ,
            parentMenuCode : {
                validators : {"stringLength":{"min":1,"max":8,"message":"父菜单编码长度不正确"},"regexp":{"regexp":"^[0-9\\-]*$","message":"父菜单编码只能是数字或者中划线"}}
            }
            ,
            menuUrl : {
