$(function(){
    ...
    $('#queryFileInfoForm #createTm').ECalendar({
        type:"time",
        stamp : false,
        offset:[0,2],
        ...
        skin:1,
        step:1,
        callback:function(v,e){revalidateDate("queryFileInfoForm","createTm");} //回调函数
    });
    ...
    $('#validateAddFileInfoForm').bootstrapValidator({
        fields : {
            ...
            ,
            businessNo1 : {
                validators : {"notEmpty":{"message":"业务编号不能为空"},"stringLength":{"min":1,"max":40,"message":"业务编号长度不正确"},"regexp":{"regexp":"^[0-9]+$","message":"业务编号只能是数字"}}
            }
            ,
            fileName1 : {
    ...
    $('#queryFileInfoForm').bootstrapValidator({
        fields : {
            ...
            ,
            businessNo : {
                validators : {"stringLength":{"min":1,"max":40,"message":"业务编号长度不正确"},"regexp":{"regexp":"^[0-9]+$","message":"业务编号只能是数字"}}
            }
            ,
            fileName : {
        ...
        success:function(data){
            if(data.code == "success"){
                ...
                for(var i=0;i<resultList.length;i++){
                    ...
                    .append("<td class=\"operateTbl\"><button class=\"btn btn-default btn-sm\" onclick=\"return queryFileInfoObject('"+resultList[i].fileNo+"');\"><i class=\"fa fa-search\"></i></button></td>");
                }
