        ...
        success:function(data){
            if(data.code == "success"){
                ...
                for(var i=0;i<resultList.length;i++){
                    ...
                    .append("<td class=\"operateTbl\"><button class=\"btn btn-default btn-sm\" onclick=\"return editOperationLog('"+resultList[i].operationId+"');\"><i class=\"fa fa-edit\"></i></button><button class=\"btn btn-default btn-sm\" onclick=\"return  delOperationLog('"+resultList[i].operationId+"');\"><i class=\"fa fa-trash-o\"></i></button><button class=\"btn btn-default btn-sm\" onclick=\"return queryOperationLogObject('"+resultList[i].operationId+"');\"><i class=\"fa fa-search\"></i></button></td>");
                }
