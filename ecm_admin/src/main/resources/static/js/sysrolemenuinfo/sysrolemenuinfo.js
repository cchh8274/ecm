$(function(){
    ...
    $("#querySysroleMenuInfoForm #createTime").ECalendar({
        type:"time",
        stamp : false,
        offset:[0,2],
        ...
        skin:1,
        step:1,
        callback:function(v,e){revalidateDate("querySysroleMenuInfoForm","createTime");} //回调函数
    });
    $("#validateUpdateSysroleMenuInfoForm #createTime3").ECalendar({
        type:"time",
        stamp : false,
        offset:[0,2],
        format:"yyyy-mm-dd hh:ii:ss",
        skin:1,
        step:1,
        callback:function(v,e){revalidateDate("validateUpdateSysroleMenuInfoForm","createTime3");} //回调函数
    });
    $("#querySysroleMenuInfoForm #upTime").ECalendar({
        type:"time",
        stamp : false,
        offset:[0,2],
        format:"yyyy-mm-dd hh:ii:ss",
        skin:1,
        step:1,
        callback:function(v,e){revalidateDate("querySysroleMenuInfoForm","upTime");} //回调函数
    });
