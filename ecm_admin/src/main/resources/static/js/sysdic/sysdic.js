$(function(){
    ...
    $("#querySysDicForm #createTime").ECalendar({
        type:"time",
        stamp : false,
        offset:[0,2],
        ...
        skin:1,
        step:1,
        callback:function(v,e){revalidateDate("querySysDicForm","createTime");} //回调函数
    });
    $("#validateAddSysDicForm #createTime1").ECalendar({
        type:"time",
        stamp : false,
        offset:[0,2],
        format:"yyyy-mm-dd hh:ii:ss",
        skin:1,
        step:1,
        callback:function(v,e){revalidateDate("validateAddSysDicForm","createTime1");} //回调函数
    });
    $("#validateUpdateSysDicForm #createTime3").ECalendar({
        type:"time",
        stamp : false,
        offset:[0,2],
        format:"yyyy-mm-dd hh:ii:ss",
        skin:1,
        step:1,
        callback:function(v,e){revalidateDate("validateUpdateSysDicForm","createTime3");} //回调函数
    });
    $("#querySysDicForm #upTime").ECalendar({
        type:"time",
        stamp : false,
        offset:[0,2],
        format:"yyyy-mm-dd hh:ii:ss",
        skin:1,
        step:1,
        callback:function(v,e){revalidateDate("querySysDicForm","upTime");} //回调函数
    });
    $("#validateAddSysDicForm #upTime1").ECalendar({
        type:"time",
        stamp : false,
        offset:[0,2],
        format:"yyyy-mm-dd hh:ii:ss",
        skin:1,
        step:1,
        callback:function(v,e){revalidateDate("validateAddSysDicForm","upTime1");} //回调函数
    });
    $("#validateUpdateSysDicForm #upTime3").ECalendar({
        type:"time",
        stamp : false,
        offset:[0,2],
        format:"yyyy-mm-dd hh:ii:ss",
        skin:1,
        step:1,
        callback:function(v,e){revalidateDate("validateUpdateSysDicForm","upTime3");} //回调函数
    });
