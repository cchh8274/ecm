...
<html>
    ...
    此处有三种配置：
    sidebar-mini    通用型
    sidebar-mini sidebar-collapse        左侧小图标型
    layout-top-nav
    根据配置，设置010为通用展开模式，020为缩小模式
    -->
    <body class="hold-transition skin-red <#if menuMode="010">sidebar-mini<#elseif menuMode="020">sidebar-mini sidebar-collapse<#else>sidebar-mini sidebar-collapse</#if>">
        <div class="wrapper">
            <!--header begin-->
                        ...
                        <ul class="nav navbar-nav">
                            <li class="dropdown user user-menu">
                                <a aria-expanded="true" href="#" class="dropdown-toggle" data-toggle="dropdown"  >
                                    <img src="${user.othInfo.userIcon}" class="user-image" alt="User Image">
