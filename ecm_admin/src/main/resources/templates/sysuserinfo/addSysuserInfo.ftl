                ...
                <form id="validateAddSysuserInfoForm" method="post" class="form-horizontal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input id="password1" name="password1"  class="form-control" placeholder="用户密码" type="password"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <#assign options="1111"/>
                        <@register.fileupdownload form="validateAddSysuserInfoForm" name="userIcon1" label="用户图标" options=options value=""
