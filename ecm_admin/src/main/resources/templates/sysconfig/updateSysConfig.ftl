            ...
            <div class="modal-content">
                <form id="validateUpdateSysConfigForm" method="post" class="form-horizontal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 title"><i class="redFont">*</i>菜单模式：</label>
                            <div class="col-lg-9">
                                <select class="form-control select2" id="menuMode3" name="menuMode3"  >
                                    <#--静态模式-start-->
                                    <#assign options={"020":"关闭模式","010":"展开模式"}/>
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 title"><i class="redFont">*</i>主页链接：</label>
                            <div class="col-lg-9">
                                <input id="mainPage3" name="mainPage3"  class="form-control" placeholder="主页链接" type="text" />
                            </div>
                        </div>
                        <div class="form-group">
