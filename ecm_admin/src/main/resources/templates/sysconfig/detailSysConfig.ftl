            ...
            <div class="modal-content">
                <form id="validateDetailSysConfigForm" method="post" class="form-horizontal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 title">菜单模式：</label>
                            <div class="col-lg-9">
                                <input id="menuMode2" name="menuMode2"  class="form-control" placeholder="菜单模式" type="text" disabled="disabled"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 title">主页链接：</label>
                            <div class="col-lg-9">
                                <input id="mainPage2" name="mainPage2"  class="form-control" placeholder="主页链接" type="text" disabled="disabled"/>
                            </div>
                        </div>
                        <div class="form-group">
