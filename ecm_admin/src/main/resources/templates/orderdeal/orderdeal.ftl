...
<#import "/orderdeal/orderdeal.ftl" as  orderdeal/>
<#import "/orderdeal/addOrderDeal.ftl" as  addOrderDeal/>
<#import "/orderdeal/updateOrderDeal.ftl" as  updateOrderDeal/>
<#import "/orderdeal/detailOrderDeal.ftl" as  detailOrderDeal/>
<#include "/management/resource.ftl"/>

<@orderdeal.orderdealHtml/>
<@addOrderDeal.addOrderDealHtml/>
<@detailOrderDeal.detailOrderDealHtml/>
<@updateOrderDeal.updateOrderDealHtml/>
    ...
    <section class="content">
        <div class="box">
            <div class="box-header">
                <form id=queryOrderDealForm class="form-horizontal form-inline">
            ...
            <div class="box-body">
                <div style="width:50px;margin:10px 0px;"><button class="btn btn-block btn-success" data-toggle="modal" data-target="#addOrderDeal">添加</button></div>
                <table id="orderDealTbl" class="table table-bordered">
                    <tr id="orderDealTR_FIRST">
                        <th></th>
                        <th>序号</th>
                        <th>id</th>
                        <th>订单号</th>
            ...
            <!--分页 start-->
            <div id="queryOrderDeal_fy" style="width: 100%;" class="gmPagination gmPagination-mini">
                <div style="float:left;margin: 10px;">
                    <select id="queryOrderDealpageSize">
...
<div>
    <input type="hidden" id="queryOrderDealcurrentPage" />
    <input type="hidden" id="queryOrderDealtotalPage" />
</div>
<script type="text/javascript" src="${props('resourceUrl')}/js/orderdeal/orderdeal.js"></script>
</#macro>
<style>
    #orderDealTbl tr .btn{display:left;margin-right:5px;padding:2.5px 6px;}
