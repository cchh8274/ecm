            ...
            <div class="box-header">
                <form id=queryTaskBasicConfigForm class="form-horizontal form-inline">
                    <div class="row dis-top">
                        ...
                        <div class="col-md-3">
                            <label class="queryTitle">所属系统：</label>
                            <div class="col-md-8">
                    ...
                    <div class="row dis-top">
                        <div class="col-md-3">
                            <label class="queryTitle">业务对象名：</label>
                            <div class="col-md-8">
                    ...
                    <div class="row dis-top">
                        ...
                        <div class="col-md-3">
                            <div class="searchDiv">
                                ...
                                <button type="button" class="btn btn-info searchBtn" onclick="searchTaskBasicConfig('','download','download.xls','taskName:任务名称,parentId:所属系统,runRule:执行规则,runStatus:并行限制,status:状态,businessObjName:业务对象名,taskCount:任务数,internetName:网卡名称,serverIp:服务器IP,businessInfo:业务参数,continueFlg:循环执行,configTime:配置时间,upPerson:修改人,upTime:修改时间')">下载</button>
                            </div>
                        </div>
                    </div>
                </form>
