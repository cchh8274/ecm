            ...
            <div class="modal-content">
                <form id="validateDetailTaskBasicConfigForm" method="post" class="form-horizontal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 title">所属系统：</label>
                            <div class="col-lg-9">
                                <input id="parentId2" name="parentId2"  class="form-control" placeholder="所属系统" type="text" disabled="disabled"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 title">并行限制：</label>
                            <div class="col-lg-9">
                                <input id="runStatus2" name="runStatus2"  class="form-control" placeholder="并行限制" type="text" disabled="disabled"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 title">业务对象名：</label>
                            <div class="col-lg-9">
                                <input id="businessObjName2" name="businessObjName2"  class="form-control" placeholder="业务对象名" type="text" disabled="disabled"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 title">日志开关：</label>
                            <div class="col-lg-9">
                                <input id="logFlg2" name="logFlg2"  class="form-control" placeholder="日志开关" type="text" disabled="disabled"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 title">循环执行：</label>
                            <div class="col-lg-9">
                                <input id="continueFlg2" name="continueFlg2"  class="form-control" placeholder="循环执行" type="text" disabled="disabled"/>
                            </div>
                        </div>
                        <div class="form-group">
