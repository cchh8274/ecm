                ...
                <form id="validateAddTaskBasicConfigForm" method="post" class="form-horizontal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input id="parentId1" name="parentId1"  class="form-control" placeholder="所属系统" type="text"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input id="businessObjName1" name="businessObjName1"  class="form-control" placeholder="业务对象名" type="text"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <select class="form-control select2" id="logFlg1" name="logFlg1">
                                    <#--静态模式-start-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <select class="form-control select2" id="continueFlg1" name="continueFlg1">
                                    <#--静态模式-start-->
                                    <#assign options={"020":"禁用","010":"启用"}/>
                                    <#list options?keys as key >
                                        <option value="${key}">${options[key]}</option>
