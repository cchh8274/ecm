...
<#import "/demoinfo/auditDemoInfo.ftl" as  auditDemoInfo/>
<#import "/demoinfo/detailDemoInfo.ftl" as  detailDemoInfo/>
<#import "/component/autoinfo/autoInfo.ftl" as  autoInfo/>
...
<@auditDemoInfo.auditDemoInfoHtml/>
                ...
                <form id=queryDemoInfoForm class="form-horizontal form-inline">
                    ...
                    <div class="row dis-top">
                        <div class="col-md-3">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control powercheck" resource="www.baidu.com" placeholder="" id="demoId" name="demoId">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <label class="queryTitle">演示名称auto：</label>
                            <div class="col-md-8">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control powercheck" resource="/fileInfo/fileInfoView2.dhtml" placeholder="" id="demoMoney" name="demoMoney">
                            </div>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row dis-top">
                        ...
                        <div class="col-md-3">
                            <div class="searchDiv">
                                <button type="button" class="btn btn-info searchBtn powercheck" resource="/fileInfo/fileInfoView1.dhtml"  onclick="searchDemoInfo('')">搜索</button>
                                <button type="button" class="btn btn-info searchBtn" onclick="searchDemoInfo('','download','download.xls','demoNm:演示名称,demoMoney:演示金额,createDate:创建日期,createTime:创建时间,selectStatic:静态选择框,selectDynamic:动态选择框,radioStatic:静态单选按钮,radioDynamic:动态单选按钮,checkboxStatic:静态复选框,checkboxDynamic:动态复选框,netAddress:网址,countNumber:整数')">下载</button>
                            </div>
                        </div>
                    </div>
                </form>
