            ...
            <div class="modal-content">
                <form id="validateDetailDemoInfoForm" method="post" class="form-horizontal">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">查看DEMO表</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <#--动态模式- end -->
                        <div class="form-group">
                            <label class="col-lg-3 title">网址：</label>
                            <div class="col-lg-9">
                                <input id="netAddress2" name="netAddress2"  class="form-control" placeholder="网址" type="text" disabled="disabled"/>
                            </div>
                        </div>
                        <div class="form-group">
