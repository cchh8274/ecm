...
<#macro updateBankamountInfoHtml>
    <div class="modal fade" id="updateBankamountInfo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="validateUpdateBankamountInfoForm" method="post" class="form-horizontal">
                    <input type="hidden" id="id_key" name="id_key" value="" />
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title" id="myModalLabel">修改银行账户表</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input id="idcard3" name="idcard3"  class="form-control" placeholder="身份证号" type="text" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 title"><i class="redFont">*</i>电话：</label>
                            <div class="col-lg-9">
                                <input id="phone3" name="phone3"  class="form-control" placeholder="电话" type="text" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 title"><i class="redFont">*</i>微信用户名称：</label>
                            <div class="col-lg-9">
                                <input id="wxName3" name="wxName3"  class="form-control" placeholder="微信用户名称" type="text" />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input id="bankAmountNo3" name="bankAmountNo3"  class="form-control" placeholder="银行账户" type="text" />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input id="bankAdress3" name="bankAdress3"  class="form-control" placeholder="开户地址" type="text" />
                            </div>
                        </div>
                        <div class="form-group">
