...
<#macro addUnionDemoMainInfoHtml>
    <div class="modal fade" id="addUnionDemoMainInfo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="validateAddUnionDemoMainInfoForm" method="post" class="form-horizontal">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title" id="myModalLabel">新增联表查询DEMO-主表</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <@register.checkbox form="validateAddUnionDemoMainInfoForm" name="checkboxStatic1" label="静态复选框" options=options value=""
                        ...
                        <@register.checkbox form="validateAddUnionDemoMainInfoForm" name="checkboxDynamic1" label="动态复选框" options=options value=""
                        class1="form-group" class2="col-lg-3 title" class3="col-lg-9" class4="checkbox-inline" class5="inline1" readOnly="false"/>
                        <#--动态模式- end -->
                        <div class="form-group">
