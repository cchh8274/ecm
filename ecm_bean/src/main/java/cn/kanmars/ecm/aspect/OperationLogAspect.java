...
import cn.kanmars.ecm.dao.TblOperationLogMapper;
...
public class OperationLogAspect {
    private HLogger logger = LoggerManager.getLoger("OperationLogAspect");
    ...
    public void recordLog(JoinPoint joinPoint,OperationLogDescription operationLogDescription) throws Throwable {
        try{
            ...
            //1、设置随机序号
            tblOperationLog.setOperationId((long) SysSequenceUtils.createSimpleId());
            //2、获取操作者信息
