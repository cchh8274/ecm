...
import web.daochange.DaochangeProcessor;
...
import web.generatorunion.GeneratorUnion;
...
public class PathHandler extends AbstractHandler {
    ...
    private GeneratorUnion generatorUnion = new GeneratorUnion();

    private DaochangeProcessor daochangeProcessor = new DaochangeProcessor();
    ...
    public void handle(String s, Request request, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws IOException, ServletException {
        ...
        }else if (s.startsWith("/generatorunion")){
            generatorUnion.process(httpServletRequest,httpServletResponse);
        ...
        }else if(s.startsWith("/daochange")){
            daochangeProcessor.process(httpServletRequest,httpServletResponse);
        }else{
            commonProcessor.process(httpServletRequest,httpServletResponse);
        }
    }
