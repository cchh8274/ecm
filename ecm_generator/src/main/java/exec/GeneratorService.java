...
public class GeneratorService {
    ...
    public static void main(String[] args) throws Exception {
        exec("E:\\work\\GFS_NEW_IntenlliJ\\ecm\\branches\\ecm-parent_0.1.0_BR",
                "Test",
                "金融业务",
    ...
    public static void exec(String basePath,String serviceName,String serviceDesc ,List<String> serviceMethodList) throws Exception{
        ...
        c.put("servicePath", basePath+"\\ecm_service\\src\\main\\java\\cn\\kanmars\\ecm\\service");
        c.put("servicePackage", "cn.kanmars.ecm.service");
        c.put("logicPath", basePath+"\\ecm_service\\src\\main\\java\\cn\\kanmars\\ecm\\logic");
        c.put("logicImplPath", basePath+"\\ecm_service\\src\\main\\java\\cn\\kanmars\\ecm\\logic\\impl");
        c.put("logicPackage", "cn.kanmars.ecm.logic");
        c.put("logicPackageImpl", "cn.kanmars.ecm.logic.impl");
    ...
    public static void createService(Context c)  throws Exception {
        ...
        sb.append("import cn.com.xbase.frame.logic.ResultEnum;").append("\r\n");
        sb.append("import cn.com.xbase.frame.util.*;").append("\r\n");

        for(Map.Entry e : logics.entrySet()){
            sb.append("import cn.kanmars.ecm.logic." + FormatUtils.firstBig(e.getKey().toString()) + ";").append("\r\n");
        }
