 ...
 * 2、指定目标名称列表，例如ecm-admin替换为gfs-admin......
 * 3、指定字符集
 * 4、指定文件类型，例如.css  .js  .java  .properties等
 * 5、全局替换文件夹，将文件夹列表按照从底层到高层的顺序，替换掉文件中的ecm-admin文件夹为gfs-admin
 * 6、全局性搜索文件，将文件中的ecm-admin，替换为gfs-admin
 *
 *
 * 使用说明：
 * 1、设置被搬家文件夹srcDir
...
public class Mover {
    ...
    public static void main(String[] args) throws Exception {
        String srcDir = "E:\\work\\GFS_NEW_IntenlliJ\\ecm\\branches\\ecm-parent_0.0.1_BR";
        //警告！！！！！目标文件夹会被清空掉，因此一定要小心确认
        String dstDir = "E:\\FGATE";
        //列出要替换的名称列表
        List<String> replaceList = new ArrayList<String>();
        replaceList.add("ecm,FGATE");
        replaceList.add("ecm,Fgate");
        replaceList.add("ecm,fgate");
        replaceList.add("ECM后台管理系统,金融系统统一网关");
        replaceList.add("ECM后台管理系统,金融");
    ...
    public static void exec(String srcDir,String dstDir,List<String> replaceList) throws Exception{
        ...
        jumpFiles.add("ecm-parent.iml");
        jumpFiles.add("ecm-admin.iml");
        jumpFiles.add("ecm-dao.iml");
        jumpFiles.add("ecm-dubbo.iml");
        jumpFiles.add("ecm-generator.iml");
        jumpFiles.add("ecm-inapi.iml");
        jumpFiles.add("ecm-outapi.iml");
        jumpFiles.add("ecm-service.iml");
        jumpFiles.add("ecm-task.iml");
        jumpFiles.add("ecm-web.iml");
