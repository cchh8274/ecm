...
public class Generator {
    ...
    public static void main(String[] args) throws Exception {
        exec(
                ...
                "E:\\work\\GFS_NEW_IntenlliJ\\ecm\\branches\\ecm-parent_0.1.0_BR",//基础路径
//                "E:\\work\\GFS_NEW_IntenlliJ\\ecm\\trunk",//基础路径
//                "C:\\workspace\\SVN\\ecm\\branches\\ecm-parent_0.0.1_BR",//基础路径
                //*******************  MYSQL数据库  *****************************************************************
                "com.mysql.jdbc.Driver",//驱动名称
                "jdbc:mysql://10.126.53.197:3306/ecm_main",//链接URL
                "snuat",//用户名称
                "123456",//密码
                "ecm_main",//schema
                //*******************  ORACLE数据库  *****************************************************************
...
//                "jdbc:sqlite:D:/sqlite.ecm.db3",//链接URL
//                "",//用户名称
//                "",//密码
//                "",//schema
                new String[]{
...
//                },
    ...
    private static void setEntityProperties(Context context){
        ...
        //增加entity的注解，则增加多个
        //context.addtoList(Context.ANNOTATION_ENTITY,"cn.kanmars.ecm.MybatisRepository");
    }
    ...
    private static void setDaoProperties(Context context){
        ...
        //增加dao的注解，则增加多个
        context.addtoList(Context.ANNOTATION_DAO,"cn.kanmars.ecm.MybatisRepository");
    }
    ...
    public static void preProcess(Context context,String basepath){
        context.put(Context.PATH_ENTITY,      basepath+"\\ecm_dao\\src\\main\\java\\cn\\kanmars\\ecm\\entity");
        context.put(Context.PATH_DAO,         basepath+"\\ecm_dao\\src\\main\\java\\cn\\kanmars\\ecm\\dao");
        context.put(Context.PATH_MAPPER,      basepath+"\\ecm_dao\\src\\main\\resources\\props\\ecm\\mapper");
        context.put(Context.PATH_LOGIC,       basepath+"\\ecm_admin\\src\\main\\java\\cn\\kanmars\\ecm\\logic");
        context.put(Context.PATH_CONTROLLER,  basepath+"\\ecm_admin\\src\\main\\java\\cn\\kanmars\\ecm\\controller");
        context.put(Context.PATH_FTL,         basepath+"\\ecm_admin\\src\\main\\resources\\templates");
        context.put(Context.PATH_JS,          basepath+"\\ecm_admin\\src\\main\\resources\\static\\js");

        context.put(Context.PACKAGE_ENTITY, "cn.kanmars.ecm.entity");
        context.put(Context.PACKAGE_DAO, "cn.kanmars.ecm.dao");
        context.put(Context.PACKAGE_LOGIC, "cn.kanmars.ecm.logic");
        context.put(Context.PACKAGE_CONTROLLER, "cn.kanmars.ecm.controller");
