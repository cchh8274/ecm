 ...
 */
public class Create_017_Js implements Pipe {
    public void exec(Context c) throws Exception {
        ...
        {//----------------------------------------------------------------------------------------------------------------
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (power.indexOf("query-condition:Y") >= 0) {
                        ...
                        //判断是否有queryrange标志
                        {
                            ...
                            try{
                                ...
                                if(queryrange_o!=null  && ((String)queryrange_o).trim().equals("true")){
                                    ...
                                    sb.append("        startOfWeek: 'monday',").append("\r\n");
                                    sb.append("        separator : ' 至 ',").append("\r\n");
                                    sb.append("        format: 'YYYY-MM-DD',").append("\r\n");
                                    sb.append("        autoClose: false").append("\r\n");
                                    sb.append("    });").append("\r\n");
                                    hasout=true;
                                }
                            }catch (Exception e){
                            ...
                            if(!hasout){
                                sb.append("    $(\"#query"+cleanentityClassName+"Form #"+column_name_tf+"\").ECalendar({").append("\r\n");
                                sb.append("        type:\"date\",").append("\r\n");
                                sb.append("        stamp : false,").append("\r\n");
                                sb.append("        offset:[0,2],").append("\r\n");
                                sb.append("        format:\"yyyy-mm-dd\",").append("\r\n");
                                sb.append("        skin:1,").append("\r\n");
                                sb.append("        callback:function(v,e){revalidateDate(\"query"+cleanentityClassName+"Form\",\""+column_name_tf+"\");} //回调函数").append("\r\n");
                                sb.append("    });").append("\r\n");
                            }
                        }
                    }
                    if (type.equals(GeneratorJSONProperties.FIELD_type_datetime)) {
                        ...
                        //判断是否有queryrange标志
                        {
                            ...
                            if(!hasout){
                                sb.append("    $('#query"+cleanentityClassName+"Form #" + column_name_tf + "').ECalendar({").append("\r\n");
                                sb.append("        type:\"time\",").append("\r\n");
                                sb.append("        stamp : false,").append("\r\n");
                                sb.append("        offset:[0,2],").append("\r\n");
                                sb.append("        format:\"yyyy-mm-dd hh:ii:ss\",").append("\r\n");
                                sb.append("        skin:1,").append("\r\n");
                ...
                if (power.indexOf("add:Y") >= 0) {
                    //列-作为查询条件-start
                    if (type.equals(GeneratorJSONProperties.FIELD_type_date)) {
                        sb.append("    $(\"#validateAdd"+cleanentityClassName+"Form #"+column_name_tf+"1\").ECalendar({").append("\r\n");
                        sb.append("        type:\"date\",").append("\r\n");
                        sb.append("        stamp : false,").append("\r\n");
                        sb.append("        offset:[0,2],").append("\r\n");
                        sb.append("        format:\"yyyy-mm-dd\",").append("\r\n");
                        sb.append("        skin:1,").append("\r\n");
                        sb.append("        callback:function(v,e){revalidateDate(\"validateAdd"+cleanentityClassName+"Form\",\""+column_name_tf+"1\");} //回调函数").append("\r\n");
                        sb.append("    });").append("\r\n");
                    }
                    if (type.equals(GeneratorJSONProperties.FIELD_type_datetime)) {
                        sb.append("    $('#validateAdd"+cleanentityClassName+"Form #" + column_name_tf + "1').ECalendar({").append("\r\n");
                ...
                if (power.indexOf("update-show:Y") >= 0 && power.indexOf("update-update:Y") >= 0) {
                    //列-作为查询条件-start
                    if (type.equals(GeneratorJSONProperties.FIELD_type_date)) {
                        sb.append("    $(\"#validateUpdate"+cleanentityClassName+"Form #"+column_name_tf+"3\").ECalendar({").append("\r\n");
                        sb.append("        type:\"date\",").append("\r\n");
                        sb.append("        stamp : false,").append("\r\n");
                        sb.append("        offset:[0,2],").append("\r\n");
                        sb.append("        format:\"yyyy-mm-dd\",").append("\r\n");
                        sb.append("        skin:1,").append("\r\n");
                        sb.append("        callback:function(v,e){revalidateDate(\"validateUpdate"+cleanentityClassName+"Form\",\""+column_name_tf+"3\");} //回调函数").append("\r\n");
                        sb.append("    });").append("\r\n");
        ...
        {//----------------------------------------------------------------------------------------------------------------
            ...
            for (int i = 0; i < count; i++) {
                ...
                try {
                    ...
                    if(StringUtils.isNotEmpty(validators)&&validators.trim().equalsIgnoreCase("{}")){
                        validators = GeneratorJSONProperties.DEFAULT_validators;
                    }
                    //处理格式转化过程中\\变成\\\\的问题
                    validators = validators.replaceAll("\\\\\\\\","\\\\");
                } catch (Exception e) {
                    e.printStackTrace();
        ...
        {//----------------------------------------------------------------------------------------------------------------
            ...
            sb.append("    jsonStr = encodeURIComponent(jsonStr);").append("\r\n");
            sb.append("    jsonStr = encodeURIComponent(jsonStr);").append("\r\n");//编码两次，处理服务器转码问题
            sb.append("    if(queryType!=undefined && queryType =='download'){").append("\r\n");
        ...
        {//----------------------------------------------------------------------------------------------------------------
            ...
            for(int i=0;i<count;i++){
                ...
                if(power.indexOf("add:Y")>=0){
                    ...
                    if(type.equals(GeneratorJSONProperties.FIELD_type_file)){
                        sb.append("    params."+column_name_tf+" = getFileupdownloadVal('validateAdd"+cleanentityClassName+"Form','"+column_name_tf+"1');").append("\r\n");
                    }


                }
            }
            sb.append("    //获取子表参数").append("\r\n");
            sb.append("    var subArray = new Array();").append("\r\n");
            if(hasSubTable.equalsIgnoreCase("true")) {
                sb.append("    $.each($(\"#validateAdd" + cleanentityClassName + "Form .sub1_\"),function(i,obj){").append("\r\n");
                sb.append("        var subNum = $(this).attr(\"subNum\");").append("\r\n");
                sb.append("        var subParams={};").append("\r\n");
                //获取子表数据
                int count_sub = (Integer) c.get(Context.CURR_SUB_TABLE_COLUMN_COUNT);
                for (int i = 0; i < count_sub; i++) {
                    ...
                    if (power.indexOf("add:Y") >= 0) {
                        //列-作为查询条件-start
                        if (type.equals(GeneratorJSONProperties.FIELD_type_input)) {
                            sb.append("        subParams." + column_name_tf + " = $(\"#validateAdd" + cleanentityClassName + "Form #" + column_name_tf + "1_\"+subNum).val();").append("\r\n");
                        }
                        if (type.equals(GeneratorJSONProperties.FIELD_type_date)) {
                            sb.append("        subParams." + column_name_tf + " = $(\"#validateAdd" + cleanentityClassName + "Form #" + column_name_tf + "1_\"+subNum).val();").append("\r\n");
                        }
                        ...
                        if (type.equals(GeneratorJSONProperties.FIELD_type_radio)) {
                            sb.append("        subParams." + column_name_tf + " = $(\"#validateAdd" + cleanentityClassName + "Form input[name='" + column_name_tf + "1_\"+subNum+\"']:checked\").val();").append("\r\n");
                        }
                        if (type.equals(GeneratorJSONProperties.FIELD_type_checkbox)) {
                            sb.append("        subParams." + column_name_tf + " = getCheckBoxVal(\"validateAdd" + cleanentityClassName + "Form\",\"" + column_name_tf + "1_\"+subNum);").append("\r\n");
                        }
                        if (type.equals(GeneratorJSONProperties.FIELD_type_file)) {
                            sb.append("        subParams." + column_name_tf + " = getFileupdownloadVal('validateAdd" + cleanentityClassName + "Form','" + column_name_tf + "1_\"+subNum+\"');").append("\r\n");
                        }
                    }
                }
                sb.append("        subArray[i] = subParams;").append("\r\n");
                sb.append("    });").append("\r\n");
            }
            sb.append("    params.subArray = subArray;").append("\r\n");
            ...
            for(int i=0;i<count;i++){
                ...
                if(power.indexOf("add:Y")>=0){
                    //列-作为查询条件-start
                    if(type.equals(GeneratorJSONProperties.FIELD_type_checkbox)){
                        sb.append("                setCheckBoxVal(\"validateAdd"+cleanentityClassName+"Form\",\""+column_name_tf+"1\",'00000000000000000000000000000000');").append("\r\n");
                    }
                    if(type.equals(GeneratorJSONProperties.FIELD_type_file)){
                        sb.append("                setFileupdownloadVal('validateAdd"+cleanentityClassName+"Form','"+column_name_tf+"1','');").append("\r\n");
                    }
                }
            }
            sb.append("                $('#validateAdd"+cleanentityClassName+"Form #subContent1 div').html('');").append("\r\n");
            sb.append("            }else{").append("\r\n");
            sb.append("                layer.alert(data.message);").append("\r\n");
        ...
        {//----------------------------------------------------------------------------------------------------------------
            ...
            for(int i=0;i<count;i++){
                ...
                //如果权限中包含“允许作为修改”
                if(power.indexOf("update-update:Y")>=0||isPrimarykey.equalsIgnoreCase("true")){
                    //列-作为查询条件-start
                    if(type.equals(GeneratorJSONProperties.FIELD_type_input)){
            ...
            sb.append("    var subArray = new Array();").append("\r\n");
            if(hasSubTable.equalsIgnoreCase("true")) {
                sb.append("    $.each($(\"#validateUpdate" + cleanentityClassName + "Form .sub3_\"),function(i,obj){").append("\r\n");
                sb.append("        var subNum = $(this).attr(\"subNum\");").append("\r\n");
                sb.append("        var subParams={};").append("\r\n");
                //获取子表数据
                int count_sub = (Integer) c.get(Context.CURR_SUB_TABLE_COLUMN_COUNT);
                for (int i = 0; i < count_sub; i++) {
                    ...
                    if (power.indexOf("update-update:Y") >= 0) {
                        //列-作为查询条件-start
                        if (type.equals(GeneratorJSONProperties.FIELD_type_input)) {
                            sb.append("        subParams." + column_name_tf + " = $(\"#validateUpdate" + cleanentityClassName + "Form #" + column_name_tf + "3_\"+subNum).val();").append("\r\n");
                        }
                        if (type.equals(GeneratorJSONProperties.FIELD_type_date)) {
                            sb.append("        subParams." + column_name_tf + " = $(\"#validateUpdate" + cleanentityClassName + "Form #" + column_name_tf + "3_\"+subNum).val();").append("\r\n");
                        }
                        ...
                        if (type.equals(GeneratorJSONProperties.FIELD_type_radio)) {
                            sb.append("        subParams." + column_name_tf + " = $(\"#validateUpdate" + cleanentityClassName + "Form input[name='" + column_name_tf + "3_\"+subNum+\"']:checked\").val();").append("\r\n");
                        }
                        if (type.equals(GeneratorJSONProperties.FIELD_type_checkbox)) {
                            sb.append("        subParams." + column_name_tf + " = getCheckBoxVal(\"validateUpdate" + cleanentityClassName + "Form\",\"" + column_name_tf + "3_\"+subNum);").append("\r\n");
                        }
                        if (type.equals(GeneratorJSONProperties.FIELD_type_file)) {
                            sb.append("        subParams." + column_name_tf + " = getFileupdownloadVal('validateUpdate" + cleanentityClassName + "Form','" + column_name_tf + "3_\"+subNum+\"');").append("\r\n");
                        }
                    }
                }
                sb.append("        subArray[i] = subParams;").append("\r\n");
            ...
            sb.append("                $('#validateUpdate"+cleanentityClassName+"Form #subContent3 div').html('');").append("\r\n");
            sb.append("            }else{").append("\r\n");
            sb.append("                layer.alert(data.message);").append("\r\n");
        ...
        {//----------------------------------------------------------------------------------------------------------------
            ...
            sb.append("                var objInfo = data.rows[0];").append("\r\n");
            //对属性仅遍历赋值-开始
            int count = (Integer)c.get(Context.CURR_TABLE_COLUMN_COUNT);//字段总数
            for(int i=0;i<count;i++){
                String column_name = (String)((List)c.get(Context.CURR_TABLE_COLUMNS_NAME)).get(i);
                ...
                if(power.indexOf("update-show:Y")>=0){
                    ...
                    if(type.equals(GeneratorJSONProperties.FIELD_type_file)){
                        sb.append("                setFileupdownloadVal('validateUpdate" + cleanentityClassName + "Form','"+column_name_tf+"3',objInfo."+column_name_tf+"!=null?objInfo."+column_name_tf+":'');").append("\r\n");
                    }
                }
            }
            if(hasSubTable.equalsIgnoreCase("true")) {
                ...
                sb.append("                $('#validateUpdate" + cleanentityClassName + "Form #subContent3 div').html('');").append("\r\n");
                sb.append("                for(var i = 0;i < data.rows[0].pageRecords.length;i++){").append("\r\n");
                sb.append("                    update" + cleanentityClassName + "Sub();").append("\r\n");
                ...
                for (int i = 0; i < count_sub; i++) {
                    ...
                    if (power.indexOf("update-show:Y") >= 0) {
                        //列-作为查询条件-start
                        if (type.equals(GeneratorJSONProperties.FIELD_type_input)) {
                            sb.append("                    $(\"#validateUpdate" + cleanentityClassName + "Form #" + column_name_tf + "3_\"+i).val(data.rows[0].pageRecords[i]." + column_name_tf + "!=null?data.rows[0].pageRecords[i]." + column_name_tf + ":'');").append("\r\n");
                        }
                        if (type.equals(GeneratorJSONProperties.FIELD_type_date)) {
                            sb.append("                    $(\"#validateUpdate" + cleanentityClassName + "Form #" + column_name_tf + "3_\"+i).val(data.rows[0].pageRecords[i]." + column_name_tf + "!=null?data.rows[0].pageRecords[i]." + column_name_tf + ":'');").append("\r\n");
                        }
                        ...
                        if (type.equals(GeneratorJSONProperties.FIELD_type_radio)) {
                            sb.append("                    //使用原生javascript对radio进行操作，避免浏览器不兼容问题").append("\r\n");
                            sb.append("                    $(\"#validateUpdate" + cleanentityClassName + "Form input[name='" + column_name_tf + "3_\"+i+\"'][value='\"+(data.rows[0].pageRecords[i]." + column_name_tf + "!=null?data.rows[0].pageRecords[i]." + column_name_tf + ":'')+\"']\")[0].checked=true;").append("\r\n");
                        }
                        if (type.equals(GeneratorJSONProperties.FIELD_type_checkbox)) {
                            sb.append("                    setCheckBoxVal(\"validateUpdate" + cleanentityClassName + "Form\",\"" + column_name_tf + "3_\"+i,(data.rows[0].pageRecords[i]." + column_name_tf + "!=null?data.rows[0].pageRecords[i]." + column_name_tf + ":''));").append("\r\n");
                        }
                        if (type.equals(GeneratorJSONProperties.FIELD_type_file)) {
                            sb.append("                    setFileupdownloadVal('validateUpdate" + cleanentityClassName + "Form','" + column_name_tf + "3_\"+i+\"',data.rows[0].pageRecords[i]." + column_name_tf + "!=null?data.rows[0].pageRecords[i]." + column_name_tf + ":'');").append("\r\n");
                        }
                    }
                }
                sb.append("                }").append("\r\n");
        ...
        {//----------------------------------------------------------------------------------------------------------------
            ...
            for(int i=0;i<count;i++){
                ...
                if(power.indexOf("detail:Y")>=0){
                    ...
                    if(type.equals(GeneratorJSONProperties.FIELD_type_file)){
                        sb.append("                setFileupdownloadVal('validateDetail" + cleanentityClassName + "Form','"+column_name_tf+"2',objInfo."+column_name_tf+"!=null?objInfo."+column_name_tf+":'');").append("\r\n");
                    }
                }
            }
            //对属性仅遍历赋值-结束
            ...
            //获取子表属性
            if(hasSubTable.equalsIgnoreCase("true")) {
                sb.append("                $('#validateDetail" + cleanentityClassName + "Form #subContent2 div').html('');").append("\r\n");
                sb.append("                var  resultList = data.rows[0].pageRecords;").append("\r\n");
                sb.append("                for(var i = 0;i < resultList.length;i++){").append("\r\n");
                sb.append("                    detail" + cleanentityClassName + "Sub('readonly');").append("\r\n");
                sb.append("                    var objInfo = resultList[i];").append("\r\n");
                ...
                for (int i = 0; i < count_sub; i++) {
                    ...
                    if (power.indexOf("detail:Y") >= 0) {
                        //列-作为查询条件-start
                        if (type.equals(GeneratorJSONProperties.FIELD_type_input)) {
                            sb.append("                    $(\"#validateDetail" + cleanentityClassName + "Form #" + column_name_tf + "2_\"+i).val(objInfo." + column_name_tf + "!=null?objInfo." + column_name_tf + ":'');").append("\r\n");
                        }
                        if (type.equals(GeneratorJSONProperties.FIELD_type_date)) {
                            sb.append("                    $(\"#validateDetail" + cleanentityClassName + "Form #" + column_name_tf + "2_\"+i).val(objInfo." + column_name_tf + "!=null?objInfo." + column_name_tf + ":'');").append("\r\n");
                        }
                        ...
                        if (type.equals(GeneratorJSONProperties.FIELD_type_select)) {
                            sb.append("                    $(\"#validateDetail" + cleanentityClassName + "Form #" + column_name_tf + "2_\"+i).val(objInfo." + column_name_tf + "_name!=null?objInfo." + column_name_tf + "_name:'');").append("\r\n");
                        }
                        if (type.equals(GeneratorJSONProperties.FIELD_type_radio)) {
                            sb.append("                    $(\"#validateDetail" + cleanentityClassName + "Form #" + column_name_tf + "2_\"+i).val(objInfo." + column_name_tf + "_name!=null?objInfo." + column_name_tf + "_name:'');").append("\r\n");
                        }
                        if (type.equals(GeneratorJSONProperties.FIELD_type_checkbox)) {
                            sb.append("                    setCheckBoxVal(\"validateDetail" + cleanentityClassName + "Form\",\"" + column_name_tf + "2_\"+i,(objInfo." + column_name_tf + "!=null?objInfo." + column_name_tf + ":''));").append("\r\n");
                        }
                        if (type.equals(GeneratorJSONProperties.FIELD_type_file)) {
                            sb.append("                    setFileupdownloadVal('validateDetail" + cleanentityClassName + "Form','" + column_name_tf + "2_\"+i+\"',objInfo." + column_name_tf + "!=null?objInfo." + column_name_tf + ":'');").append("\r\n");
                        }
                    }
                }
                sb.append("                }").append("\r\n");
        ...
        sb.append("function colseSub(fromName,divId){").append("\r\n");
        sb.append("    $('#' + fromName + ' #' + divId).remove();").append("\r\n");
        sb.append("}").append("\r\n");
        sb.append("").append("\r\n");
