 ...
 */
public class Create_015_Controller implements Pipe {
...
//创建文件夹
        ...
        sb.append("import cn.com.xbase.frame.util.DateFormatUtils;").append("\r\n");
        sb.append("import cn.com.xbase.frame.util.MapObjTransUtils;").append("\r\n");
        sb.append("import cn.com.xbase.frame.util.MoneyFormatUtils;").append("\r\n");
        sb.append("import cn.com.xbase.frame.util.StringUtils;").append("\r\n");
        sb.append("import cn.com.xbase.frame.util.DateUtils;").append("\r\n");
        sb.append("import cn.com.xbase.frame.interceptor.OperationLogDescription;").append("\r\n");
        sb.append("import cn.kanmars.ecm.util.SysSequenceUtils;").append("\r\n");
        sb.append("import cn.kanmars.ecm.util.SysDicUtils;").append("\r\n");
        sb.append("import cn.kanmars.ecm.base.AdvancedAjaxBaseController;").append("\r\n");
        ...
        sb.append("            HashMap param = new HashMap();").append("\r\n");
        sb.append("            param.put(\"id_key\",jsonObject.get(\"id_key\").toString());").append("\r\n");
        sb.append("            result = "+logicVarName+".query"+cleanentityClassName+"(param);").append("\r\n");
        sb.append("            result = afterLogic(request,result);").append("\r\n");
        ...
        sb.append("    @OperationLogDescription(operationName=\"插入\",operationApp = \"ecm-admin\")").append("\r\n");
        ...
        sb.append("            " + logicVarName + ".insert"+cleanentityClassName+"(paramMap);").append("\r\n");
        ...
        sb.append("    @OperationLogDescription(operationName=\"修改\",operationApp = \"ecm-admin\")").append("\r\n");
        ...
        sb.append("            HashMap<String, Object> paramMap = new HashMap<String, Object>();").append("\r\n");
        sb.append("            paramMap = beferLogic(request, jsonObject);").append("\r\n");
        sb.append("            " + logicVarName + ".update"+cleanentityClassName+"(paramMap);").append("\r\n");
        ...
        sb.append("    @OperationLogDescription(operationName=\"删除\",operationApp = \"ecm-admin\")").append("\r\n");
        ...
        sb.append("            HashMap paramMap = new HashMap();").append("\r\n");
        sb.append("            paramMap.put(\"id_key\",id_key);").append("\r\n");
        sb.append("            "+logicVarName+".delete"+cleanentityClassName+"(paramMap);").append("\r\n");
        ...
        sb.append("            List<JSONObject> subArray = (List<JSONObject>) obj.get(PageQueryUtil.SUBARRAY);").append("\r\n");
        sb.append("            if (subArray != null) {").append("\r\n");
        sb.append("                List<HashMap<String, Object>> recordsList = new ArrayList<HashMap<String,Object>>();").append("\r\n");
        sb.append("                // 如果是分页的查询，则对每一个结果进行处理").append("\r\n");
        sb.append("                for (JSONObject cell_of_list : subArray) {").append("\r\n");
        sb.append("                    HashMap<String, Object> resultMap = beferLogic(request, cell_of_list);").append("\r\n");
        sb.append("                    recordsList.add(resultMap);").append("\r\n");
        sb.append("                }").append("\r\n");
        sb.append("                result.put(PageQueryUtil.SUBARRAY , recordsList);").append("\r\n");
        sb.append("            }").append("\r\n");
        sb.append("            //*********************************************************").append("\r\n");
        ...
        for(int i=0;i<count;i++){
            ...
            if(type.equals(GeneratorJSONProperties.FIELD_type_input)){
                ...
                if(ismoney.equals("true")){
                    ...
                    //如果不是金额，并且是long的情况下
                    String islong = GeneratorJSONProperties.DEFAULT_islong;
                    String column_type = (String)((List)c.get(Context.CURR_TABLE_COLUMNS_TYPE)).get(i);//获取到数据库类型
                    ...
                    String javaType = TypeUtils.transDBType2MapperJavaType(column_type, column_size, decimal_digits);
                    if(javaType.equals("java.lang.Long")||javaType.equals("java.math.BigDecimal")){
                        sb.append("            if (result.keySet().contains(\""+column_name_tf+"\")) {").append("\r\n");
                        sb.append("                String key = \""+column_name_tf+"\";").append("\r\n");
                        sb.append("                Object value = result.get(key);").append("\r\n");
                        sb.append("                if(value != null){").append("\r\n");
                        sb.append("                    //Long和BigDecimal转化为字符串，防止javascript不支持大数异常").append("\r\n");
                        sb.append("                    result.put(key, value.toString());").append("\r\n");
                        sb.append("                }").append("\r\n");
                        sb.append("            }").append("\r\n");
                    }
                }
            ...
            if(type.equals(GeneratorJSONProperties.FIELD_type_file)){
                ...
                if(javaType.equals("java.lang.Long")||javaType.equals("java.math.BigDecimal")){
                    ...
                    sb.append("                Object value = result.get(key);").append("\r\n");
                    sb.append("                if(value != null){").append("\r\n");
                    sb.append("                    //文件编号如果是long或者BigDecimal时转化为字符串，防止javascript不支持大数异常").append("\r\n");
                    sb.append("                    result.put(key, value.toString());").append("\r\n");
                    sb.append("                }").append("\r\n");
                    sb.append("            }").append("\r\n");
                }
