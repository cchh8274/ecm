...
public class MoverPatternerUtils {
    public static void main(String[] args) {
        ...
        strList.add("/ecm/");
        strList.add("ecm-admin");
        strList.add("/ecm");
        strList.add("/ecm/ecm-c-ecm-d-ecm/");
        strList.add("ecm/ecm/ecm-c-ecm-d-ecm/ecm");
        strList.add("ecm/ecm/ecm-c-ecm-d-ecm/SNADMIN/ecm-SNCONTROLLER");

        for(String s : strList) {
            System.out.println(transStr(s,"ecm","KKK"));
        }
