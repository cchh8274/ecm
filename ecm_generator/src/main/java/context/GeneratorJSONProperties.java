...
public class GeneratorJSONProperties {
    ...
    public static final String FIELD_type_blob = "blob";//文件块
    public static final String FIELD_type_file = "file";//文本编号
    ...
    //islong，input框专用属性，位于attr下一级(input是否是long,因为javascript不支持long，所以需要在afterlogic中转化为字符串)
    public static final String PATH_islong = "islong";
    public static final String DEFAULT_islong = "false";
    ...
    public static final String PATH_isPrimarykey = "isPrimarykey";
    public static final String DEFAULT_isPrimarykey = "false";
