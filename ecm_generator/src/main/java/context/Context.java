...
public class Context extends HashMap {
    ...
    public static final String CURR_SUB_TABLE_COLUMN_COUNT ="curr.sub.table.column.count";//当前表的列的数量
    public static final String CURR_SUB_TABLE_COLUMNS_NAME ="curr.sub.table.column.names";//当前表的列的原始名称
    public static final String CURR_SUB_TABLE_COLUMNS_NAME_TF ="curr.sub.table.column.names.tf";//当前表的列的原始名称的驼峰形式
    public static final String CURR_SUB_TABLE_COLUMNS_COMMENT_ALL ="curr.sub.table.column.comment.all";//当前表的列的备注，全数据
    public static final String CURR_SUB_TABLE_COLUMNS_COMMENT ="curr.sub.table.column.comment";//当前表的列的备注
    public static final String CURR_SUB_TABLE_COLUMNS_COMMENT_JSON ="curr.sub.table.column.comment.json";//当前表的列的备注
    public static final String CURR_SUB_TABLE_COLUMNS_TYPE ="curr.sub.table.column.type";//当前表的列的类型
    public static final String CURR_SUB_TABLE_COLUMNS_TYPE_COLUMN_SIZE ="curr.sub.table.column.type.column.size";//当前表的列的类型的长度
    public static final String CURR_SUB_TABLE_COLUMNS_TYPE_COLUMN_DECIMAL_DIGITS ="curr.sub.table.column.type.column.size.decimal.digits";//当前表的列的类型的小数位精度


    //list
    public static final String UNION_QUERY_TABLES_TABLENAME_LIST = "union.query.tables.tablename.list";
    //list
    public static final String UNION_QUERY_TABLES_TABLEALIAS_LIST = "union.query.tables.tablealias.list";

    public static final String UNION_QUERY_TABLES_MAIN_TABLENAME = "union.query.tables.main.tablename";
    //list
    public static final String UNION_QUERY_TABLES_SLAVE_TABLENAMES = "union.query.tables.slave.tablenames";

    public static final String UNION_QUERY_TABLES_SUB_TABLENAME = "union.query.tables.sub.tablename";
    ...
    //是否有从表
    public static final Object HAS_SLAVE_TABLES = "has.slave.tables";
    //是否有子表
    public static final Object HAS_SUB_TABLE = "has.sub.table";
