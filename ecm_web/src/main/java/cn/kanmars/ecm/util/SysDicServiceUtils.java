...
import cn.kanmars.ecm.feign.ecm_SysDicFacadeServiceInterface;
 ...
 * ecm_web专用的SysDicUtil
 */
@Component
public class SysDicServiceUtils {
    /** 精确到第三层级的字典 */
    ...
    @Autowired
    private ecm_SysDicFacadeServiceInterface ecm_SysDicFacadeServiceInterface_;

    private static ecm_SysDicFacadeServiceInterface ecm_SysDicFacadeServiceInterface;

    @PostConstruct
    public void init(){
        ecm_SysDicFacadeServiceInterface = ecm_SysDicFacadeServiceInterface_;
    }
    ...
    public static HashMap getSysDicInDB(String l1Code, String l2Code, String codeParam) {
        Map<String,Object> result = ecm_SysDicFacadeServiceInterface.getOne(l1Code,l2Code,codeParam);
    ...
    public static List<HashMap> getSysDicListInDB(String l1Code, String l2Code) {
        Map<String,Object> result = ecm_SysDicFacadeServiceInterface.getList(l1Code,l2Code);
        if(((String)(result.get("resCode"))).equals("0000")){
